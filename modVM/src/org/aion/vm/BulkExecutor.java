...
public final class BulkExecutor {
     ...
     */
    public static List<AionTxExecSummary> executeAllTransactionsInBlock(IAionBlock block, RepositoryCache repository, boolean isLocalCall, boolean incrementSenderNonce, boolean fork040Enable, boolean checkBlockEnergyLimit, Logger logger, PostExecutionWork postExecutionWork) throws VMException {
     ...
     * @param logger The logger.
     */
    public static AionTxExecSummary executeTransactionWithNoPostExecutionWork(IAionBlock block, AionTransaction transaction, RepositoryCache repository, boolean isLocalCall, boolean incrementSenderNonce, boolean fork040Enable, boolean checkBlockEnergyLimit, Logger logger) throws VMException {
    ...
    private static List<AionTxExecSummary> executeInternal(IAionBlock block, List<AionTransaction> transactions, RepositoryCache repository, PostExecutionWork postExecutionWork, Logger logger, boolean checkBlockEnergyLimit, boolean incrementSenderNonce, boolean isLocalCall, boolean fork040enabled) throws VMException {
